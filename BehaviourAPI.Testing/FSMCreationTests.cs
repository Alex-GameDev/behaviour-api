namespace BehaviourAPI.Testing
{
    ...
    public class FSMCreationTests
    {
        ...
        public void Test_FSM_Simple_Creation()
        {
            ...
            Transition t = fsm.CreateTransition<Transition>("t_s1_s2", s1, s2, new ConditionalPerception(() => true));
        ...
        public void Test_FSM_Complex_Creation()
        {
            ...
            Transition t12 = fsm.CreateTransition<Transition>("t12", s1, s2, new ConditionalPerception(() => true));
            Transition t13 = fsm.CreateTransition<Transition>("t13", s1, s3, new ConditionalPerception(() => true));
            Transition t14 = fsm.CreateTransition<Transition>("t14", s1, s4, new ConditionalPerception(() => true));
            Transition t23 = fsm.CreateTransition<Transition>("t23", s2, s3, new ConditionalPerception(() => true));
            Transition t24_1 = fsm.CreateTransition<Transition>("t241", s2, s4, new ConditionalPerception(() => true));
            Transition t24_2 = fsm.CreateTransition<Transition>("t242", s2, s4, new ConditionalPerception(() => true));
            Transition t4_5 = fsm.CreateTransition<Transition>("t45", s4, s5, new ConditionalPerception(() => true));
            Transition t3_6 = fsm.CreateTransition<Transition>("t36", s3, s6, new ConditionalPerception(() => true));
