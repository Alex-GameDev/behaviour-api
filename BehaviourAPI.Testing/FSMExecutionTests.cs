namespace BehaviourAPI.Testing
{
    ...
    public class FSMExecutionTests
    {
        ...
        public void Test_FSM_Transition()
        {
            ...
            Transition t = fsm.CreateTransition("t", s1, s2);
        ...
        public void Test_FSM_MultipleTransitions()
        {
            ...
            Transition t1_2 = fsm.CreateTransition("t12", s1, s2, new ConditionPerception(() => false));
            Transition t1_3 = fsm.CreateTransition("t13", s1, s3);

            Transition t2_1 = fsm.CreateTransition("t21", s2, s1, new ConditionPerception(() => false));
            Transition t2_3 = fsm.CreateTransition("t23", s2, s3, new ConditionPerception(() => false));

            Transition t3_1 = fsm.CreateTransition("t31", s3, s2);
            Transition t3_2 = fsm.CreateTransition("t32", s3, s1);
        ...
        public void Test_FSM_SubFSM()
        {
            ...
            var s2 = parent.CreateState("st2", new SubsystemAction(child));
            var s3 = parent.CreateState("st3", new FunctionalAction(() => Status.Running));
            var t1_2 = parent.CreateTransition("t12", s1, s2);
            var t2_3 = parent.CreateTransition("t2_3", s2, s3, new ExecutionStatusPerception(s2, StatusFlags.Failure));

            var s4 = child.CreateState("st4", new FunctionalAction(() => Status.Running));
            var s5 = child.CreateExitTransition("st5", s4, Status.Failure);
        ...
        public void Test_FSM_StackFSM()
        {
            ...
            var t3_r = fsm.CreatePopTransition("recuperado_desde_tirar", st3, new ConditionPerception(() => !herido));
            var t4_r = fsm.CreatePopTransition("recuperado_desde_beber", st4, new ConditionPerception(() => !herido));
